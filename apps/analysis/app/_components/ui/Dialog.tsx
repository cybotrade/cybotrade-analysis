...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={clsx(
      'fixed inset-0 z-50 bg-[#714614] opacity-80 backdrop-blur-sm data-[state=open]:animate-in ',
      'data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 ',
      'dark:bg-[#382B0C] opacity-80',
      className,
    )}
    {...props}
  />
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={clsx(
        ...
        'gap-4 border border-neutral-200 bg-white p-6 shadow-lg',
        ...
        'sm:rounded-lg md:w-full dark:border-neutral-800 dark:bg-[#37332A]',
        className,
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Close ref={ref} className={clsx('', className)} {...props} />
));

...
export const DashboardFooter = () => {
  return (
    <div className="mb-3 font-sora flex justify-center items-end gap-10 max-w-4xl h-fit mx-auto rounded-full border border-[#F8E6C9] bg-white px-12 py-4 shadow-md shadow-primary-light/50">

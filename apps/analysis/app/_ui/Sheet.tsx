...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      'fixed inset-0 z-50 bg-[#714614]/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className,
    )}
    {...props}
    ref={ref}
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = 'right', className, overlayClassName, children, overlayChildren, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay className={overlayClassName}>{overlayChildren}</SheetOverlay>

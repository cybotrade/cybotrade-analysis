...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex cursor-default select-none items-center rounded-lg p-1.5 text-sm font-medium outline-none focus:bg-[#FEECD4] focus:text-black data-[state=open]:bg-[#FEECD4] data-[state=open]:text-black dark:focus:bg-neutral-800 dark:focus:text-neutral-50 dark:data-[state=open]:bg-neutral-800 dark:data-[state=open]:text-neutral-50',
      className,
    )}
    {...props}
  />
